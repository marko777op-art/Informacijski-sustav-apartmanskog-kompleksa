...
public class ApartmanNaRezervaciji {
    ...
    public ApartmanNaRezervaciji(int id, String opis, String lokacija, int kapacitet, double cijena, LocalDate dolazak, LocalDate odlazak) {
        this.idApartmana = id;
